/* 
/ check_excel2003_biff4_1904.c
/
/ Test cases for Excel 1904 start date
/
...
int main (int argc, char *argv[])
{
    ...
    ret = freexl_open ("testdata/simple2003_4_1904.xls", &handle);
    if (ret != FREEXL_OK) {
    ...
    if (info != FREEXL_BIFF_DATEMODE_1904)
    {
    ...
    if (strcmp(cell_value.value.text_value, "1971-10-02") != 0) {
    ...
    if (strcmp(cell_value.value.text_value, "2008-12-01") != 0) {
